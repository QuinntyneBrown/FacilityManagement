param (
    $resourceBaseName="facilityManagement$( Get-Random -Maximum 1000)",
    $location='eastus'
)
...
dotnet build ..\src\FacilityManagement.Api\FacilityManagement.Api.csproj

Write-Host 'Packaging API project for deployment' -ForegroundColor Green
dotnet publish ..\src\FacilityManagement.Api\FacilityManagement.Api.csproj --self-contained -r win-x86 -o ..\publish
